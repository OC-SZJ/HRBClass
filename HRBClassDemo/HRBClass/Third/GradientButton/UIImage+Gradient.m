...
+ (UIImage *)normalImageWithSize:(CGSize)size{
    return   [[UIImage alloc] createImageWithSize:size gradientColors:@[[UIColor colorWithHexString:@"#007CFF"],[UIColor colorWithHexString:@"#00C1FE"]] percentage:@[@0.3,@1] gradientType:GradientFromLeftToRight];
}
